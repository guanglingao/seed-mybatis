...
public class ColumnDefinition {
    ...
    public String getColumnNameLF() {
        return ClassField.lowerFirstLetter(this.columnName);
    }
    ...
    public ColumnTypeConverter getColumnTypeConverter() {
        throw new UnsupportedOperationException("未覆盖org.seed.mybatis.maven.ColumnDefinition.getColumnTypeConverter方法");
    }
